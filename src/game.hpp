...
class Game
{
	...
	static constexpr int brickSpacing{3};
...
public:
	Game()
	{
		liberationSans.loadFromFile(R"(/home/ishan/LiberationMono-Regular.ttf)");
		gamescore = 0;
		currentStage = 0;
	...
	void run()
	{
		while(true)
		{
			...
			// If game is in progree and space bar is hit, then shoot bullets
